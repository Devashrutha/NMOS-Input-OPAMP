...
$$
\begin{aligned}
I_D =\mu_n \operatorname{cox}\left(\frac{W}{L}\right) \cdot \frac{\left(V_{G S}-V_t\right)^2}{2} \\
...
$$
\begin{aligned}
{g_{m}}^2=\left[\mu_n \operatorname{cox}\left(\frac{w}{L}\right)\right]^2 \frac{\left(V_{G S}-V_{t}\right)^2}{2} \times 2 \\
{g_m}^2=2 I_D \times \mu_n \operatorname{cox}\left(\frac{W}{L}\right)\\
